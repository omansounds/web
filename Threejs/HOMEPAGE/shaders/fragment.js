...
void main() {
  ...
  vec3 finalColor = -vec3(pnoise(vec3(1.0 - newPosition.y * 200.0 + uTime)) * 80.0) * (0.01 - full) * patternColor;

  // Combine raymarch and pattern effects
  vec3 color = mix(raymarchColor, finalColor, 0.7);  // Mix both effects with 50% blend
